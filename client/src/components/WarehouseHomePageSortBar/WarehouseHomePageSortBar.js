    ...
    return (
        <div className='warehouse-home-page-sort-bar__sort-buttons-container'>
            <button className='warehouse-home-page-sort-bar__sort' onClick={sortWarehouse}>
                ...
                <img className={sort === 'warehouse' ? 'warehouse-home-page-sort-bar__sort-icon--active' : 'inventory-home-page-sort-bar__sort-icon'} src={sortIcon} alt='sort icon'></img>
            </button>
            <button className='warehouse-home-page-sort-bar__sort' onClick={sortAddress}>
                ...
                <img className={sort === 'address' ? 'warehouse-home-page-sort-bar__sort-icon--active' : 'inventory-home-page-sort-bar__sort-icon'} src={sortIcon} alt='sort icon'></img>
            </button>
            <button className='warehouse-home-page-sort-bar__sort' onClick={sortContactName}>
                ...
                <img className={sort === 'contactName' ? 'warehouse-home-page-sort-bar__sort-icon--active' : 'inventory-home-page-sort-bar__sort-icon'} src={sortIcon} alt='sort icon'></img>
            </button>
            <button className='warehouse-home-page-sort-bar__sort' onClick={sortContactInfo}>
                ...
                <img className={sort === 'contactInfo' ? 'warehouse-home-page-sort-bar__sort-icon--active' : 'inventory-home-page-sort-bar__sort-icon'} src={sortIcon} alt='sort icon'></img>
            </button>
