    ...
    return (
        <div className='warehouse-details-page-sort-bar__sort-buttons-container'>
            <button className='warehouse-details-page-sort-bar__sort' onClick={sortInventory}>
                ...
                <img className={sort === 'inventory' ? 'warehouse-details-page-sort-bar__sort-icon--active' : ''} src={sortIcon} alt='sort icon'></img>
            </button>
            <button className='warehouse-details-page-sort-bar__sort' onClick={sortCategory}>
                ...
                <img className={sort === 'category' ? 'warehouse-details-page-sort-bar__sort-icon--active' : ''} src={sortIcon} alt='sort icon'></img>
            </button>
            <button className='warehouse-details-page-sort-bar__sort' onClick={sortStatus}>
                ...
                <img className={sort === 'status' ? 'warehouse-details-page-sort-bar__sort-icon--active' : ''} src={sortIcon} alt='sort icon'></img>
            </button>
            <button className='warehouse-details-page-sort-bar__sort' onClick={sortQuantity}>
                ...
                <img className={sort === 'quantity' ? 'warehouse-details-page-sort-bar__sort-icon--active' : ''} src={sortIcon} alt='sort icon'></img>
            </button>
